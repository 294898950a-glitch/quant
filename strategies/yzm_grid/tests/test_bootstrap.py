"""yzm_grid bootstrap 测试 —— 全部用 tmp_path + 合成 parquet。"""
...
from strategies.yzm_grid.bootstrap import (
    DEFAULT_YAML_PATH,
...
def test_bootstrap_creates_files(tmp_path: Path):
    ...
    parquet = tmp_path / "raw" / "300415_daily.parquet"
