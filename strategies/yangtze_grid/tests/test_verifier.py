...
from strategies.yangtze_grid.verifier import (
    INITIAL_CAPITAL,
...
def test_run_backtest_trades_are_TradeRecord():
    """trades list 元素是 cb.TradeRecord，且 cb_code 标记为 600900。"""
    weights = [10, 60, 0.10]
    ...
    if result.trades:
        ...
        # 标的代码标记为 yangtze 600900
        assert first.cb_code == "600900"
